...
public class InputValidationLedRange extends DocumentFilter {
	...
	public void replace(DocumentFilter.FilterBypass fb, int offset, int length, String text, AttributeSet attrs)
		...
		if (foundNonDigit) {
			JOptionPane.showMessageDialog(null,
					"Only digits, space, Semicolon and Dash are allowed. Other characters have been removed from your input.");
		}
